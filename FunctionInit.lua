...
--[[Tele Tab]]
  MangAdmin:PrepareScript(ma_ContScrollBarEntry1  , nil , function() MangAdmin.db.char.selectedCont = "KA"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry2  , nil , function() MangAdmin.db.char.selectedCont = "EK"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry3  , nil , function() MangAdmin.db.char.selectedCont = "OUTL"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry4  , nil , function() MangAdmin.db.char.selectedCont = "NRTH"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry5  , nil , function() MangAdmin.db.char.selectedCont = "MAEL"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry6  , nil , function() MangAdmin.db.char.selectedCont = "PANDA"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry7  , nil , function() MangAdmin.db.char.selectedCont = "DRA"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry8  , nil , function() MangAdmin.db.char.selectedCont = "BISLES"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
  MangAdmin:PrepareScript(ma_ContScrollBarEntry9  , nil , function() MangAdmin.db.char.selectedCont = "OT"; cont=MangAdmin.db.char.selectedCont; TeleScrollUpdate() end)
