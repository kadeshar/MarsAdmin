...
--[[General]]
  --[[Tooltips]]
    ["ma_IconHint"] = "|cffeda55fClick|r to open MarsAdmin. |cffeda55fShift-Click|r to reload the user interface.",
    ["tt_Default"] = "Move your cursor over an element to toggle the tooltip!",
    ["tt_LanguageButton"] = "Change the language and reload MarsAdmin.",
  --[[Control Labels]]
  ...
  --[[Other]]
    ["slashcmds"] = { "/marsadmin", "/mars" },
    ["lang"] = "English",
    ["realm"] = "|cFF00FF00Realm:|r ", --do not change this line!
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"] = "GM",
  --[[Tooltips]]
    ["tt_MainButton"] = "Toggle MarsAdmins Mainframe.",
